...
// Protocol (pipe, text, \n-terminated):
//   CLIENTâ†’SERVER:  REGISTER <spec> [<name>]
//                   UNREGISTER <name_or_spec>
//                   PING
//   SERVERâ†’CLIENT:  HELLO WinKeyHook
//                   OK <name_or_spec>
//                   ERR <reason>
...
// â”€â”€â”€ Debug log â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Combo structures â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
struct ComboSlot {
...
std::list<Combo>  g_combos;
std::list<Client> g_clients;

std::set<DWORD>   g_pressed;    // hook-thread only â†’ no lock needed
std::set<DWORD>   g_suppressed;

std::atomic<DWORD> g_next_client_id{1};

// â”€â”€â”€ Key name parser â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Pipe helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
static void PipeSend(HANDLE pipe, const char* msg) {
    DWORD w;
    WriteFile(pipe, msg, (DWORD)strlen(msg), &w, NULL);
}

static void PipeSendf(HANDLE pipe, const char* fmt, ...) {
    char buf[512];
    va_list a; va_start(a, fmt); vsprintf_s(buf, fmt, a); va_end(a);
    PipeSend(pipe, buf);
}

// â”€â”€â”€ Watchdog thread â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Pipe client thread â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
DWORD WINAPI ClientThread(LPVOID raw) {
    ...
    for (;;) {
        // Non-blocking check: how many bytes has the client sent?
        DWORD avail = 0;
        if (!PeekNamedPipe(pipe, NULL, 0, NULL, &avail, NULL)) break; // client disconnected

        if (avail == 0) {
            Sleep(10);  // nothing to read â€” yield so WriteFile can run
            continue;
        }

        // Data is available: read exactly one byte (immediately returns)
        char c; DWORD rd;
        ...
        if (cmd == "REGISTER") {
            ...
            if (dup) PipeSend(pipe, "ERR already_registered\n");
            else {
                PipeSendf(pipe, "OK %s\n", ident.c_str());
    ...
    // Cleanup: remove all combos owned by this client
...
// â”€â”€â”€ Pipe accept thread â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
DWORD WINAPI PipeAcceptThread(LPVOID) {
    for (;;) {
        ...
        CreateThread(NULL, 0, ClientThread, p, 0, NULL);
    }
    return 0;
}

// â”€â”€â”€ Desktop-switch event hook â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
void CALLBACK WinEventProc(HWINEVENTHOOK, DWORD event,
                            HWND, LONG, LONG, DWORD, DWORD)
{
    if (event == EVENT_SYSTEM_DESKTOPSWITCH) {
        Log("DESKTOP_SWITCH: clearing state");
        // Runs on main thread via DispatchMessage â†’ same thread as hook â†’ no CS needed here
        g_pressed.clear();
        g_suppressed.clear();
        for (auto& c : g_combos) c.active = false;
    }
}

// â”€â”€â”€ Low-level keyboard hook â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
LRESULT CALLBACK LowLevelKeyboardProc(int nCode, WPARAM wParam, LPARAM lParam) {
    ...
    // â”€â”€ KEY DOWN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (keyDown) {
    ...
    // â”€â”€ KEY UP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (keyUp) {
...
static void PrintTutorial() {
    printf(
        ...
        "    Connect from any process. Only one keyHook instance runs.\n"
        "\n"
        ...
        "\n"
        "  COMPILE\n"
        "    cl.exe /EHsc keyHook.cpp /link user32.lib\n"
        "\n"
        "  +---------------------------------------------------------+\n"
        "\n"
    );
...
int main(int argc, char* argv[]) {
    ...
    if (argc < 2) {
        // Detect direct launch (Explorer double-click): fresh console has cursor at (0,0).
        // Terminal launch: cursor is already further down the buffer.
    ...
    // â”€â”€ Parse CLI combos: <spec> [--name <name>] ... â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    int cli_idx = 0;
    for (int i = 2; i < argc; ) {
        std::string arg(argv[i]);
        if (arg == "--name") { i += 2; continue; }  // orphan --name â†’ skip
    ...
    if (parent_pid != 0)
        CreateThread(NULL, 0, WatchdogThread, (LPVOID)(uintptr_t)parent_pid, 0, NULL);

    CreateThread(NULL, 0, PipeAcceptThread, NULL, 0, NULL);
    ...
    if (!g_win_event_hook)
        Log("WARNING: SetWinEventHook failed â€” UAC/lock recovery disabled");
